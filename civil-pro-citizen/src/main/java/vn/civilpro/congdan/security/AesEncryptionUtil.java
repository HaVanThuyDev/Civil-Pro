...
public final class AesEncryptionUtil {
    ...
    private static final String DEFAULT_SECRET = "CivilProEnterpriseSecretKey2026SecureCitizenApp";
    ...
    public static String encrypt(String plainText) {
        ...
        try {
            ...
            log.error("Error encrypting citizen PII value: {}", e.getMessage());
            return plainText;
        }
    }
    ...
    public static String decrypt(String cipherText) {
        ...
        try {
            ...
            log.error("Error decrypting citizen PII value: {}", e.getMessage());
            return cipherText;
        }
    }
}
